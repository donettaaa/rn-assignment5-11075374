...
const HomeScreen = () => {
  ...
  return (
    <Container style={{ backgroundColor: theme.background }}>
      <Header>
        <ProfileImage source={require('../assets/Donetta.jpg')} />
        <WelcomeContainer>
          <WelcomeText>Welcome back,</WelcomeText>
          <UserName>Donetta Dodoh</UserName>
        </WelcomeContainer>
        <SearchIcon source= {require('../assets/search1.png')} />
      </Header>
      <CardImage source={require('../assets/Card.png')} />
      <Actions>
        <ActionButton>
          <ActionIconCircle>
            <ActionIcon source={require('../assets/sent1.png')} />
          </ActionIconCircle>
          <ActionText>Sent</ActionText>
        </ActionButton>
        <ActionButton>
          <ActionIconCircle>
            <ActionIcon source={require('../assets/receive1.png')} />
          </ActionIconCircle>
          <ActionText>Receive</ActionText>
        </ActionButton>
        <ActionButton>
          <ActionIconCircle>
            <ActionIcon source={require('../assets/loan1.png')} />
          </ActionIconCircle>
        ...
        <TransactionList>
          <TransactionItem>
            <TransactionIconCircle>
              <TransactionIcon source={require('../assets/applelogo.jpg')} />
            </TransactionIconCircle>
            <TransactionDetails>
          ...
          <TransactionItem>
            <TransactionIconCircle>
              <TransactionIcon source={require('../assets/moneytransfer.jpg')} />
            </TransactionIconCircle>
            <TransactionDetails>
          ...
          <TransactionItem>
            <TransactionIconCircle>
              <TransactionIcon source={require('../assets/groceryshopping.jpg')} />
            </TransactionIconCircle>
            <TransactionDetails>
